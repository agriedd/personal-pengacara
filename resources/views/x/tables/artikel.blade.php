        ...
        <template v-slot:default="data">
            <td>
                <div class="d-flex justify-content-end">
                    <div class="img-md bg-gray-light rounded" v-src:xs="data.item.cover"></div>
                </div>
            </td>
            ...
            <td>
                <div v-if="data.item.info && data.item.info.status">
                    <div class="px-3 py-2 badge badge-pill font-weight-normal badge-success d-flex shadow-sm mb-2">
                        <div class="pr-3">
                    ...
                    <div class="text-muted small">
                        @{{ data.item.info.published_at_diff }}
                    </div>
                    <div class="text-muted small">
                        @{{ data.item.info.published_at }}
                    </div>
                </div>
                <div v-else>
            ...
            <td>
                <div class="d-flex">
                    <button class="btn btn-sm btn-rounded text-success" @click.prevent="update('artikel', data.index)">
                        <div class="d-flex">
                            <div class="pr-3">
                    ...
                    <button class="btn text-danger" @click.prevent="konfirmasiHapus('artikel', data.index)">
