        ...
        <template v-slot:default="data">
            ...
            <td>
                <div class="d-flex">
                    ...
                    <a href="javascript:void(0)" @click.prevent="insert('galeri', data.index)" class="img-sm bg-gray-light rounded shadow-sm text-dark d-flex justify-content-center"  v-tooltip="{ content: 'Tambah Galeri', offset: 8}" title="Tambah galeri">
