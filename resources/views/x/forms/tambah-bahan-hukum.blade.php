<form action="" v-on:submit.prevent="submit('bahan_hukum', $event)" enctype="multipart/form-data">
    <div class="form-group">
        <label for="" class="text-gray-light small">
            Berkas
        </label>
                ...
                <transition name="fly-up" mode="out-in">
                    <div :key="bahan_hukum.hasFile('berkas')">
                        <label for="berkas" class="d-block w-100 mb-0" style="cursor: pointer" v-if="!bahan_hukum.hasFile('berkas')">
                            ...
                            <input type="file" ref="berkas" id="berkas" class="form-control d-none" required name="berkas" v-on:change="selectFile($event, 'bahan_hukum', 'berkas')">
                        </label>
                        <div v-else>
