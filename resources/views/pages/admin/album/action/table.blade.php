<div class="btn-group">
    ...
    <button class="btn btn-link text-dark shadow-none" type="button" @click="album.toggleCollapse('filter')">
        <transition name="zoom" mode="out-in">
            <div :key="album.getCollapse('filter')">
                <div v-if="album.getCollapse('filter')">
