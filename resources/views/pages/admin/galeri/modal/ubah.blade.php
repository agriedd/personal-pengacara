        ...
        <div class="d-flex">
            ...
            <div>
                ...
                <div class="small text-muted">
                    Formulir untuk mengubah data album dengan id @{{ album.getSelected('id') }}
                </div>
            </div>
        </div>
        <div>
            <button class="btn btn-light btn-sm rounded-pill px-3 py-2 text-muted" v-on:click="album.closeModal('ubah')">
                Tutup <i class="fa fa-times d-md-inline-block d-none"></i>
            </button>
        </div>
    </div>
    <hr class="divider row">
    @component('x.forms.ubah-album')
    @endcomponent
</div>