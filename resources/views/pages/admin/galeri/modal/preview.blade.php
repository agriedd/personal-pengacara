...
<div class="d-flex flex-md-row flex-column">
    ...
    <div class="h-auto d-flex flex-md-column flex-row" style="max-width: 100%; overflow-x: auto;">
        <div class="p-1 rounded d-md-block d-none" :class="[ {'bg-primary': galeri.getSelected('id') == item.id } ]" v-for="(item, i) in galeri.getData()">
            <div class="img-lg rounded" v-src:md="item.gambar" style="cursor: pointer;" @click="selectGaleri(i)">

            </div>
        </div>
        <div class="p-1 rounded d-md-none d-block" :class="[ {'bg-primary': galeri.getSelected('id') == item.id } ]" v-for="(item, i) in galeri.getData()">
